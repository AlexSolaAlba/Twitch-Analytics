...
{
    private RefreshTwitchTokenService $refreshTwitchTokenService;
    private UserValidator $userValidator;
    private UserRepositoryInterface $userRepository;
    public function __construct(
        RefreshTwitchTokenService $refreshTwitchTokenService,
        UserValidator $userValidator,
        UserRepositoryInterface $userRepository
    )
    {
        $this->refreshTwitchTokenService = $refreshTwitchTokenService;
    ...
    {
        try {
            $twitchUser = $this->refreshTwitchTokenService->refreshTwitchToken();
